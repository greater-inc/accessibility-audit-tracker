...
export const STATUS_CONFIG = {
  'not-started': { label: 'Not started', dot: 'bg-white border border-gray-400 dark:bg-gray-800 dark:border-gray-500', text: 'text-gray-400 dark:text-gray-500',   symbol: ''    },
  'pass':        { label: 'Pass',        dot: 'bg-green-500',                                                           text: 'text-green-700 dark:text-green-400', symbol: '✓'   },
  'fail':        { label: 'Fail',        dot: 'bg-red-500',                                                             text: 'text-red-700 dark:text-red-400',     symbol: '✗'   },
  'in-progress': { label: 'In progress', dot: 'bg-amber-400',                                                           text: 'text-amber-700 dark:text-amber-400', symbol: ''    },
  'na':          { label: 'N/A',         dot: 'bg-gray-400 dark:bg-gray-500',                                           text: 'text-gray-500 dark:text-gray-400',   symbol: 'N/A' },
}
